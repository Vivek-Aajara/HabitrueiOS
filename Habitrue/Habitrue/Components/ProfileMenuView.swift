...
// Ex. Approach: VStack backbone again — close button row, avatar, name block,
// Divider, then a stack of MenuRow. This view knows nothing about how it's
// presented (sheet vs slide-over); that's the parent's job.
...
#Preview {
    ProfileMenuView(
        userName: "Aditya", tagline: "Keep your streak alive",
